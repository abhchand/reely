module Admin
  module Audit
    class UserDescriptionService < BaseDescriptionService
      ...
      def description
        case
        when created_as_native?
          describe_created_as_native
        when created_as_omniauth?
          describe_created_as_omniauth
        when updated_to_deactivated?
          describe_updated_to_deactivated
        when updated_to_activated?
          describe_updated_to_activated
        when updated_to_add_role?
          describe_updated_to_add_role
        when updated_to_remove_role?
          describe_updated_to_remove_role
        else
          unknown_audit_type
        end
      end
      ...
      def updated_to_deactivated?
        update_action? && modified?('deactivated_at') &&
      ...
      def updated_to_add_role?
        ...
        update_action? && modified?('audited_roles') &&
