$(document).ready(function() {
  var origCollectionName;
  var newCollectionName;

  $(".collections-editable-name-heading").on("focus", ".collections-editable-name-heading__textarea", function(e) {
    origCollectionName = e.target.value;
  });

  $(".collections-editable-name-heading").on("blur", ".collections-editable-name-heading__textarea", function(e) {
    updateCollectionName();
  });

  $(".collections-editable-name-heading__textarea").keydown(function(e) {
    // Enter Key
    if (e.keyCode == 13) {
      e.preventDefault();
      e.target.blur();
    ...
    // Escape Key
    if (e.keyCode === 27) {
      var textArea = $(".collections-editable-name-heading__textarea");
