...
RSpec.describe User do
  ...
  describe 'Associations' do
    ...
    it do
      should have_many(:received_collections).through(
               :shared_collection_recipients
             )
    end
  ...
  describe 'validations' do
    ...
    describe 'email' do
      ...
      it 'validates format' do
        %w[abcd@xyz.com ab.cd@xyz.com ABCD@xyz.com].each do |value|
      ...
      context 'native' do
        ...
        describe '#additional_password_requirements' do
          ...
          it 'errors on invalid passwords' do
            %w[Ind 7777!777 IndianOcean7].each do |bad_password|
    ...
    describe 'before_create' do
      ...
      describe '#generate_confirmation_token' do
        it 'does not generate a confirmation_token' do
          ...
          expect { user.save! }.to_not(change { user.confirmation_token })
        end
  ...
  describe 'HasAuditableRoles module' do
    ...
    describe '#add_role' do
      ...
      it 'audits the change' do
        expect { user.add_role(:manager, modifier: modifier) }.to change {
          Audited::Audit.count
        }.by(1)
    ...
    describe '#remove_role' do
      ...
      it 'audits the change' do
        expect { user.remove_role(:manager, modifier: modifier) }.to change {
          Audited::Audit.count
        }.by(1)
